...
import SocioSelector
  from '../components/SocioSelector';

import ResumenCobro
  from '../components/ResumenCobro';

import FormularioPago
  from '../components/FormularioPago';

import QrPagoModal
  from '../components/QrPAgoModal';
  ...
  const openSocio =
    async (
      ...
      try {
        ...
        setMessage(
          error?.message ||
          'Ocurrió un error al cargar los cobros',
        );
      ...
      try {
        ...
        if (
          ...
          if (
            ...
            setMessage(
              'El servidor no devolvió la imagen del QR',
            );
            ...
            <div className="flex min-h-140 items-center justify-center p-6">
              ...
              <div className="max-w-sm text-center">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  ...
                  Elige un socio para revisar sus acciones
                  y cobros pendientes.
        ...
        <aside className="space-y-4">
          ...
          <div className="rounded-xl border border-blue-100 bg-blue-50 p-4">
            ...
            <p className="mt-1 text-xs leading-5 text-blue-800/80">
              ...
              Selecciona uno o varios conceptos.
              El monto se calcula automáticamente
              según los saldos pendientes.
